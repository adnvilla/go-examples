...
const file_echo_proto_rawDesc = "" +
	...
	"\x04Echo\x128\n" +
	"\tUnaryEcho\x12\x14.echo.v1.EchoRequest\x1a\x15.echo.v1.EchoResponse\x127\n" +
	"\bSlowEcho\x12\x14.echo.v1.EchoRequest\x1a\x15.echo.v1.EchoResponse\x12;\n" +
	"\bBidiEcho\x12\x14.echo.v1.EchoRequest\x1a\x15.echo.v1.EchoResponse(\x010\x01B?Z=github.com/adnvilla/go-examples/examples/grpc-advanced/echopbb\x06proto3"
...
var file_echo_proto_depIdxs = []int32{
	...
	0, // 1: echo.v1.Echo.SlowEcho:input_type -> echo.v1.EchoRequest
	0, // 2: echo.v1.Echo.BidiEcho:input_type -> echo.v1.EchoRequest
	1, // 3: echo.v1.Echo.UnaryEcho:output_type -> echo.v1.EchoResponse
	1, // 4: echo.v1.Echo.SlowEcho:output_type -> echo.v1.EchoResponse
	1, // 5: echo.v1.Echo.BidiEcho:output_type -> echo.v1.EchoResponse
